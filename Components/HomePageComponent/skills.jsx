...
const skillsData = [
  ...
  },
  {
    ...
    description:
      "Connecting front-end applications with back-end services and consuming APIs.",
    icon: (
      <svg
        stroke="currentColor"
        fill="currentColor"
    ...
    skills: ["REST APIs", "Fetching & updating data efficiently"],
  },
  {
    ...
    <section id="skills" className="py-20 ">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold mb-2 text-gray-950">My Skills</h2>
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {skill.skills.map((s, i) => (
                  <span
                    key={i}
                    className="text-xs bg-blue-100 text-blue-600 px-2 py-1 rounded-full flex items-center"
                  >
                    {s}
                  </span>
                ))}
